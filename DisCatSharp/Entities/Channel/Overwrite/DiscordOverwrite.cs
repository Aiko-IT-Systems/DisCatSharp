...
#region Methods
	...
	public Task DeleteAsync(string reason = null)
		=> this.Discord.ApiClient.DeleteChannelPermissionAsync(this.ChannelId, this.Id, reason);
	...
	public async Task<DiscordRole> GetRoleAsync() =>
		this.Type != OverwriteType.Role
			...
			: (await this.Discord.ApiClient.GetChannelAsync(this.ChannelId).ConfigureAwait(false)).Guild
			.GetRole(this.Id);
