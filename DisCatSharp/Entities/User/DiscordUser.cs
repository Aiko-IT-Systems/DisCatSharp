...
public class DiscordUser : SnowflakeObject, IEquatable<DiscordUser>
{
	...
	/// <param name="oauth2Client">The oauth2 client.</param>
	/// <exception cref="NullReferenceException">Thrown when <see cref="AccessToken" /> is not present.</exception>
	public Task OAuth2DeleteApplicationRoleConnectionAsync(DiscordOAuth2Client oauth2Client)
		=> this.AccessToken is not null ? oauth2Client.DeleteCurrentUserApplicationRoleConnectionAsync(this.AccessToken) : throw new NullReferenceException("You need to specify the AccessToken on this DiscordUser entity.");
