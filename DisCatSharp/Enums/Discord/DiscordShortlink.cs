...
public static class DiscordShortlink
{
	...
	public static readonly string
		TrustAndSafety = $"{DiscordDomain.GetDomain(CoreDomain.DiscordMarketing).Url}/request";
	...
	public static readonly string TranslationError =
		$"{DiscordDomain.GetDomain(CoreDomain.DiscordMarketing).Url}/lang-feedback";
