...
public static class LinqMethods
{
	...
	public static bool TryGetFirstValueWhere<TSource>(
		this List<TSource?> list, Func<TSource?, bool> predicate,
		out TSource? value
	)
	{
		if (list.EmptyOrNull())
	...
	public static bool TryGetFirstValueByKey<TKey, TValue>(
