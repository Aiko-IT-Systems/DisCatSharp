...
var builder = new SearchIndexBuilder(options.RepositoryRoot, options.DocsRoot, options.SiteRoot);
...
internal sealed record CliOptions(string RepositoryRoot, string DocsRoot, string SiteRoot, string OutputPath, string? SourceCommit)
{
