...
public sealed class DiscordIngressPublicUrls
{
	...
	public static DiscordIngressPublicUrls Create(Uri baseUrl, DiscordAspNetCoreIngressOptions? options = null)
	{
		...
		return new(baseUrl, ingressRootPath, ingressRootUrl, oauthCallbackUrl, interactionsUrl, webhookEventsUrl, incomingWebhooksUrl);
	}
