...
},...B,..._,...M,I,P,...z,...q,U,V]}}})();hljs.registerLanguage("swift",e)})();/*! `apache` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("php-template",n)})();/*! `accesslog` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("accesslog",e)})();/*! `dockerfile` grammar compiled for Highlight.js 11.5.1 */
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `dns` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("dns",d)})();/*! `fsharp` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict";function e(e){
