...
<html>
    ...
    <head>
      ...
      <title>Class LavalinkNodeConnection
     | DisCatSharp Docs </title>
      <meta name="viewport" content="width=device-width">
      <meta name="title" content="Class LavalinkNodeConnection
     | DisCatSharp Docs ">
  ...
  <h1 id="DisCatSharp_Lavalink_LavalinkNodeConnection" data-uid="DisCatSharp.Lavalink.LavalinkNodeConnection" class="text-break">Class LavalinkNodeConnection
  </h1>
...
<p>This is only available for version 3.3.1 and greater.</p></p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
