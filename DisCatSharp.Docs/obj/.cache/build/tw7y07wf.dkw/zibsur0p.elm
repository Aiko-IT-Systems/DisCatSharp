  ...
  <strong>Made with ♥ by AITSYS</strong>
      ...
      <div id="sidetoggle">
        <div id="sidetoc"></div>
                    ...
                    <article class="content wrap" id="_content" data-uid="DisCatSharp.DiscordIntents">


  <h1 id="DisCatSharp_DiscordIntents" data-uid="DisCatSharp.DiscordIntents" class="text-break">
...
Enum DiscordIntents
  ...
  <div class="markdown level0 summary"><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Represents gateway intents to be specified for connecting to Discord.</p>
</div>
  ...
  <h5 id="DisCatSharp_DiscordIntents_syntax">Syntax</h5>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td id="DisCatSharp_DiscordIntents_All">All</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="4">Includes all intents.
<p>The <a class="xref" href="DisCatSharp.DiscordIntents.html#DisCatSharp_DiscordIntents_GuildMembers">GuildMembers</a>, <a class="xref" href="DisCatSharp.DiscordIntents.html#DisCatSharp_DiscordIntents_GuildPresences">GuildPresences</a> and <a class="xref" href="DisCatSharp.DiscordIntents.html#DisCatSharp_DiscordIntents_MessageContent">MessageContent</a> intents are privileged, and must be enabled on the bot&apos;s developer page.</p>
<p>The <a class="xref" href="DisCatSharp.DiscordIntents.html#DisCatSharp_DiscordIntents_MessageContent">MessageContent</a> exist only in v10.</p>
</td>
      </tr>
      <tr>
        <td id="DisCatSharp_DiscordIntents_AllUnprivileged">AllUnprivileged</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="4">Includes all unprivileged intents.
<p>These are all intents excluding <a class="xref" href="DisCatSharp.DiscordIntents.html#DisCatSharp_DiscordIntents_GuildMembers">GuildMembers</a> and <a class="xref" href="DisCatSharp.DiscordIntents.html#DisCatSharp_DiscordIntents_GuildPresences">GuildPresences</a>.</p>
<p>The <a class="xref" href="DisCatSharp.DiscordIntents.html#DisCatSharp_DiscordIntents_GuildMessages">GuildMessages</a> will be excluded as of April 2022.</p>
</td>
      </tr>
      <tr>
        <td id="DisCatSharp_DiscordIntents_AllV9Less">AllV9Less</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="4">Includes all intents.
<p>The <a class="xref" href="DisCatSharp.DiscordIntents.html#DisCatSharp_DiscordIntents_GuildMembers">GuildMembers</a> and <a class="xref" href="DisCatSharp.DiscordIntents.html#DisCatSharp_DiscordIntents_GuildPresences">GuildPresences</a> intents are privileged, and must be enabled on the bot&apos;s developer page.</p>
<p>The <a class="xref" href="DisCatSharp.DiscordIntents.html#DisCatSharp_DiscordIntents_MessageContent">MessageContent</a> exist only in v10 and is removed here.</p>
</td>
      </tr>
      <tr>
        <td id="DisCatSharp_DiscordIntents_AutoModerationConfiguration">AutoModerationConfiguration</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="3">Whether to include automod configuration events.
<p>These include <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_AutomodRuleCreated">AutomodRuleCreated</a>, <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_AutomodRuleUpdated">AutomodRuleUpdated</a> and <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_AutomodRuleDeleted">AutomodRuleDeleted</a>.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_AutoModerationExecution">AutoModerationExecution</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="3">Whether to include automod execution events.
<p>These includes <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_AutomodActionExecuted">AutomodActionExecuted</a>.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_DirectMessageReactions">DirectMessageReactions</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="5">Whether to include direct message reaction events.
...
<p>These events only fire for DM channels.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_DirectMessages">DirectMessages</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="5">Whether to include general direct message events.
...
<p>These events only fire for DM channels.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_DirectMessageTyping">DirectMessageTyping</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="4">Whether to include direct message typing events.
...
<p>This event only fires for DM channels.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_GuildBans">GuildBans</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="3">Whether to include guild ban events.
<p>These include <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_GuildBanAdded">GuildBanAdded</a> and <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_GuildBanRemoved">GuildBanRemoved</a>.</p>
</td>
      </tr>
      <tr>
        <td id="DisCatSharp_DiscordIntents_GuildEmojisAndStickers">GuildEmojisAndStickers</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="3">Whether to include guild emoji and sticker events.
<p>This includes <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_GuildEmojisUpdated">GuildEmojisUpdated</a> and <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_GuildStickersUpdated">GuildStickersUpdated</a>.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_GuildIntegrations">GuildIntegrations</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="3">Whether to include guild integration events.
<p>This includes <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_GuildIntegrationsUpdated">GuildIntegrationsUpdated</a>.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_GuildInvites">GuildInvites</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="3">Whether to include guild invite events.
<p>These include <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_InviteCreated">InviteCreated</a> and <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_InviteDeleted">InviteDeleted</a>.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_GuildMembers">GuildMembers</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="4">Whether to include guild member events.
...
<p>This is a privileged intent, and must be enabled on the bot&apos;s developer page.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_GuildMessageReactions">GuildMessageReactions</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="4">Whether to include guild reaction events.
...
<p>and <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_MessageReactionRemovedEmoji">MessageReactionRemovedEmoji</a>.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_GuildMessages">GuildMessages</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="4">Whether to include guild message events. Note that you may receive empty contents if you don&apos;t have the message content intent.
...
<p>These include <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_MessageCreated">MessageCreated</a>, <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_MessageUpdated">MessageUpdated</a>, and <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_MessageDeleted">MessageDeleted</a>.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_GuildMessageTyping">GuildMessageTyping</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="3">Whether to include guild typing events.
<p>These include <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_TypingStarted">TypingStarted</a>.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_GuildPresences">GuildPresences</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="4">Whether to include guild presence events.
...
<p>This is a privileged intent, and must be enabled on the bot&apos;s developer page.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_Guilds">Guilds</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="8">Whether to include general guild events. Note that you may receive empty message contents if you don&apos;t have the message content intent.
...
<p><a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_ThreadListSynced">ThreadListSynced</a>, <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_ThreadMemberUpdated">ThreadMemberUpdated</a> and <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_ThreadMembersUpdated">ThreadMembersUpdated</a>.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_GuildScheduledEvents">GuildScheduledEvents</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="4">Whether to include guild scheduled event events.
...
<p><a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_GuildScheduledEventUserAdded">GuildScheduledEventUserAdded</a> and <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_GuildScheduledEventUserRemoved">GuildScheduledEventUserRemoved</a>.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_GuildVoiceStates">GuildVoiceStates</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="3">Whether to include guild voice state events.
<p>This includes <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_VoiceStateUpdated">VoiceStateUpdated</a>.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_GuildWebhooks">GuildWebhooks</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="3">Whether to include guild webhook events.
<p>This includes <a class="xref" href="DisCatSharp.DiscordClient.html#DisCatSharp_DiscordClient_WebhooksUpdated">WebhooksUpdated</a>.</p>
      ...
      <tr>
        <td id="DisCatSharp_DiscordIntents_MessageContent">MessageContent</td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="2" sourceendlinenumber="3">Whether to include the content of guild messages.
See <a href="https://support-dev.discord.com/hc/en-us/articles/4404772028055-Message-Content-Privileged-Intent-for-Verified-Bots" data-raw-source="https://support-dev.discord.com/hc/en-us/articles/4404772028055-Message-Content-Privileged-Intent-for-Verified-Bots" sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntents.yml" sourcestartlinenumber="3" sourceendlinenumber="3">https://support-dev.discord.com/hc/en-us/articles/4404772028055-Message-Content-Privileged-Intent-for-Verified-Bots</a> for more information.</p>
  ...
  <div>
      <a class="xref" href="DisCatSharp.DiscordIntentExtensions.html#DisCatSharp_DiscordIntentExtensions_HasIntent_DisCatSharp_DiscordIntents_DisCatSharp_DiscordIntents_">DiscordIntentExtensions.HasIntent(DiscordIntents)</a>
  </div>
  <div>
      <a class="xref" href="DisCatSharp.DiscordIntentExtensions.html#DisCatSharp_DiscordIntentExtensions_AddIntent_DisCatSharp_DiscordIntents_DisCatSharp_DiscordIntents_">DiscordIntentExtensions.AddIntent(DiscordIntents)</a>
  </div>
  <div>
      <a class="xref" href="DisCatSharp.DiscordIntentExtensions.html#DisCatSharp_DiscordIntentExtensions_RemoveIntent_DisCatSharp_DiscordIntents_DisCatSharp_DiscordIntents_">DiscordIntentExtensions.RemoveIntent(DiscordIntents)</a>
  </div>
