...
<html>
    ...
    <head>
      ...
      <title>Class DiscordIntentExtensions
 | DisCatSharp Docs </title>
  ...
  <h1 id="DisCatSharp_DiscordIntentExtensions" data-uid="DisCatSharp.DiscordIntentExtensions" class="text-break">Class DiscordIntentExtensions
</h1>
  <div class="markdown level0 summary"><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntentExtensions.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Represents a discord intent extensions.</p>
</div>
  ...
  <div class="markdown level1 summary"><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntentExtensions.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Adds an intent to these intents.</p>
</div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntentExtensions.yml" sourcestartlinenumber="1" sourceendlinenumber="1">The base intents.</p>
</td>
      </tr>
      <tr>
        <td><a class="xref" href="DisCatSharp.DiscordIntents.html">DiscordIntents</a></td>
        <td><span class="parametername">toAdd</span></td>
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntentExtensions.yml" sourcestartlinenumber="1" sourceendlinenumber="1">The intents to add.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <div class="markdown level1 summary"><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntentExtensions.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Calculates whether these intents have a certain intent.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntentExtensions.yml" sourcestartlinenumber="1" sourceendlinenumber="1">The intents to search for.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <div class="markdown level1 summary"><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntentExtensions.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Removes an intent from these intents.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><p sourcefile="api/DisCatSharp/DisCatSharp.DiscordIntentExtensions.yml" sourcestartlinenumber="1" sourceendlinenumber="1">The intents to remove.</p>
</td>
      </tr>
    </tbody>
  </table>
