...
<html>
 ...
 | DisCatSharp Docs </title>
      ...
      <meta name="title" content="Class Internals
 | DisCatSharp Docs ">
      <meta name="og:title" content="Class Internals
 | DisCatSharp Docs ">
  ...
  <strong>Made with ♥ by AITSYS</strong>
      ...
      <div id="sidetoggle">
        <div id="sidetoc"></div>
                    ...
                    <article class="content wrap" id="_content" data-uid="DisCatSharp.Internals">


  <h1 id="DisCatSharp_Internals" data-uid="DisCatSharp.Internals" class="text-break">Class Internals
</h1>
  <div class="markdown level0 summary"><p sourcefile="api/DisCatSharp/DisCatSharp.Internals.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Internal tools.</p>
</div>
  <div class="markdown level0 conceptual"></div>
  <div class="inheritance">
    <h5>Inheritance</h5>
    <div class="level0"><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.object">Object</a></div>
    <div class="level1"><span class="xref">Internals</span></div>
  </div>
  ...
  <h5 id="DisCatSharp_Internals_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static class Internals : object</code></pre>
  </div>
