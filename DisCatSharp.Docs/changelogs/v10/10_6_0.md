...
DiscordConfiguration configuration = new()
{
    ...
    UpdateCheckGitHubToken = "ghp_your_token" // Set this to use a personal accesss token, in case you're getting rate limited or you have access to private extensions
};
```
