...
🛠️ [DiscordGuild.BanMemberAsync](xref:DisCatSharp.Entities.DiscordGuild.BanMemberAsync*) now supports [DiscordUser](xref:DisCatSharp.Entities.DiscordUser) as [argument](xref:DisCatSharp.Entities.DiscordGuild.BanMemberAsync*).
