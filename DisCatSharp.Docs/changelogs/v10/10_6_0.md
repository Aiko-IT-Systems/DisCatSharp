...
> You can continue to use our [Discord server](https://discord.gg/Uk7sggRBTm) for support tho.
...
The addition of new fields in API payloads means our updates can be more responsive to Discord's evolving platform, keeping your bot at the cutting edge.
...
- **Join the Conversation:** Have ideas or questions? Join our [Discord community](https://discord.gg/Uk7sggRBTm) to discuss features, get help, or just chat with fellow developers.
