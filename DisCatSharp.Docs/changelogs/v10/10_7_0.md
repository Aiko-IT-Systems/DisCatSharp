...
> Please refer for all changes to https://discord.com/channels/858089281214087179/976624429935251527 and the [GitHub commit history](https://github.com/Aiko-IT-Systems/DisCatSharp/compare/v10.6.6...main).
...
- [`DiscordEmoji PaginationEmojis.Left`](xref:DisCatSharp.Interactivity.Entities.PaginationEmojis.Left)
- [`DiscordEmoji PaginationEmojis.Right`](xref:DisCatSharp.Interactivity.Entities.PaginationEmojis.Right)
- [`DiscordEmoji PaginationEmojis.SkipLeft`](xref:DisCatSharp.Interactivity.Entities.PaginationEmojis.SkipLeft)
- [`DiscordEmoji PaginationEmojis.SkipRight`](xref:DisCatSharp.Interactivity.Entities.PaginationEmojis.SkipRight)
- [`DiscordEmoji PaginationEmojis.Stop`](xref:DisCatSharp.Interactivity.Entities.PaginationEmojis.Stop)
...
- [DiscordGuild.ModifyCurrentMemberAsync](xref:DisCatSharp.Entities.DiscordGuild.ModifyCurrentMemberAsync*)
...
- **`DisCatSharp.VoiceNext`** — Removed. Replaced by `DisCatSharp.Voice`. See the [Migration Guide](xref:modules_audio_voice_migration).
