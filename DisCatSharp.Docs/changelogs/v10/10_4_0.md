...
- Added [EntitlementSkuIds](xref:DisCatSharp.Entities.DiscordInteraction#DisCatSharp_Entities_DiscordInteraction_EntitlementSkuIds) to get the entitlement sku ids.
- Added [InteractionResponseType](xref:DisCatSharp.Enums.InteractionResponseType) `InteractionRequiresPremiumSubscription`.
...
- Added [EntitlementSkuIds](xref:DisCatSharp.ApplicationCommands.Context.BaseContext#DisCatSharp_ApplicationCommands_Context_BaseContext_EntitlementSkuIds) to [BaseContext](xref:DisCatSharp.ApplicationCommands.Context.BaseContext).
