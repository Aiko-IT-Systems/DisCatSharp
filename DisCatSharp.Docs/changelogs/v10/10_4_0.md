...
- Added method [UnverifyAsync](xref:DisCatSharp.Entities.DiscordMember#DisCatSharp_Entities_DiscordMember_UnverifyAsync_System_String_) to un-verify a member.
