...
➕ Added [TryGetPublishedListings](xref:DisCatSharp.DiscordClient#DisCatSharp_DiscordClient_TryGetPublishedListings_System_UInt64_) to get the published premium sku listings for an application.
...
Additionally we've added the function [TryGetPublishedListings](xref:DisCatSharp.DiscordClient#DisCatSharp_DiscordClient_TryGetPublishedListings_System_UInt64_) to get the published premium sku listings for an application.
